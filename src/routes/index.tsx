    ...
    <div className="aurora-bg flex min-h-screen flex-col bg-background text-foreground">
      <header className="flex items-center justify-between gap-2 px-4 py-3 sm:px-6 sm:py-4">
        <div className="flex min-w-0 items-center gap-2">
          <img src="/freedumeet.png" alt="FreeduMeet" className="size-8 shrink-0 rounded-xl object-cover sm:size-9" />
      ...
      <footer className="border-t border-border px-4 py-10 sm:px-6">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-sm text-muted-foreground sm:flex-row">
          <div className="flex items-center gap-2">
            <img src="/freedumeet.png" alt="FreeduMeet" className="size-7 rounded-lg object-cover" />
